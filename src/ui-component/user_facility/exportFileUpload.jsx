...
const UploadBulkFile = ({ drawerOpen, setDrawerOpen, getReqestUrl }) => {
  const theme = useTheme();
  const primary = '#039123';
  const lightGreen = '#e8f5e9';
  console.log(getReqestUrl);
  ...
  const handleFileUpload = () => {
    if (selectedFile) {
      dispatch(uploadBulkFacilities({ file: selectedFile, reqUrl: getReqestUrl }));
      setSelectedFile(null);
      setFileName('');
  ...
  return (
    ...
    >
      <Box sx={{ p: 3, height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <DetailSection icon={<AttachFileIcon />} title="Facility Information">
          {fileName && (
          ...
          <Grid container spacing={3} alignItems="center" justifyContent="flex-start">
            ...
            <Grid item>
              <Button
                ...
                sx={{ width: '180px', py: 1, borderRadius: '30px', color: primary, borderColor: primary }}
              >
                Select File
              </Button>
            </Grid>
          ...
          <Box sx={{ mt: 4, mb: 4, maxWidth: '100%', margin: 'start' }}>
            <Accordion elevation={3}>
              ...
              >
                <HelpOutlineIcon sx={{ color: primary, mr: 1.5 }} />
