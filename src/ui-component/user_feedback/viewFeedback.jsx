...
// const ViewFeedbackDetail = ({ drawerOpen, setDrawerOpen, item, setPage }) => {
...
//         <Typography variant='h6'>{item.createdBy}</Typography>
//         <Typography variant='h6'>{item.createdUser}</Typography>
        ...
        <Box sx={{ flexGrow: 1, overflowY: 'auto' }}>
          ...
          <Paper elevation={0} sx={{ p: 3, mb: 3, border: '1px solid #e0e0e0', borderRadius: 2 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                ...
                <Typography variant="body1">{item?.createdBy || 'N/A'}</Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
          ...
          <Paper elevation={0} sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              ...
              <Typography variant="h6" fontWeight={600}>Meta Information</Typography>
            </Box>
            <Typography variant="subtitle2" color="text.secondary">Created At</Typography>
            <Typography variant="body1">{item?.createdAt || 'Not Available'}</Typography>
          </Paper>
        </Box>
      </Box>
    </Drawer>
